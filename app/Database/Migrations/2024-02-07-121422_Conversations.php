...
class Conversations extends Migration
{
    public function up()
    {
        ...
        CREATE TABLE `conversations` (
            ...
            `nom` varchar(75) COLLATE utf8mb4_bin DEFAULT NULL,
            `description` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
            `image_id` int unsigned DEFAULT NULL,
            `type_id` int unsigned NOT NULL,
            `etat` varchar(45) COLLATE utf8mb4_bin NOT NULL DEFAULT '1' COMMENT 'inactive/active',
            `origin` varchar(45) COLLATE utf8mb4_bin NOT NULL DEFAULT 'App',
            PRIMARY KEY (`id`),
            KEY `conversation_image_foreign_idx` (`image_id`),
            KEY `conversation_type_foreign_idx` (`type_id`),
            ...
            CONSTRAINT `conversation_type_foreign` FOREIGN KEY (`type_id`) REFERENCES `conversation_types` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
