...
class ConversationMembres extends Migration
{
    public function up()
    {
        ...
        CREATE TABLE `conversation_membres` (
            ...
            `isAdmin` tinyint NOT NULL DEFAULT '1' COMMENT 'Dans une conversation de groupe, seul un admin peut supprimer la conversation. Dans les autres cas, tout le monde est admin par défaut.',
            PRIMARY KEY (`id`),
